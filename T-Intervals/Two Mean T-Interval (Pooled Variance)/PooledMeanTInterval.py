# File Name: PooledMeanTInterval.py
...
print("Two Mean T-Interval (Pooled Variance)")
print("")
...
df = n1 + n2 - 2
std_devp = math.sqrt((((n1 - 1) * pow(std_dev1, 2)) + ((n2 - 1) * pow(std_dev2, 2))) / (n1 + n2 - 2))
std_err = std_devp * math.sqrt((1.0 / n1) + (1.0 / n2))
